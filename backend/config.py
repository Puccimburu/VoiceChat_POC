...
PLATFORM_MONGO_URI = os.environ.get("PLATFORM_MONGO_URI", "mongodb+srv://execouser:kvBCLWs1xRSHNq6M@genaiexeco.mftcjhw.mongodb.net/genaiexeco-devlocal?authSource=admin")
